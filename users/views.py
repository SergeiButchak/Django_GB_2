...
def profile(request):
    if request.method == 'POST':
        ...
        form_profile = UserProfileEditForm(instance=request.user.userprofile, data=request.POST)
        ...
        form_profile = UserProfileEditForm(instance=request.user.userprofile)
    context = {
